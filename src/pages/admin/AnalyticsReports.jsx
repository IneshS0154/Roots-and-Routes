...
const AnalyticsReports = () => {
    const handleExportCSV = () => {
        const csvContent = [
            ...
            [],
            ["Metric", "Value", "Trend"],
            ["Total Revenue", "LKR 284,500", "+12%"],
            ["New Users", "128", "+24%"],
            ["Orders Placed", "841", "+6%"],
            ["Avg. Order Value", "LKR 338", "-2%"],
            [],
            ["Monthly Revenue Index"],
            ["Month", "Value"],
            ["Jan", "60"], ["Feb", "80"], ["Mar", "50"], ["Apr", "90"], ["May", "75"], ["Jun", "110"],
            ["Jul", "95"], ["Aug", "120"], ["Sep", "85"], ["Oct", "100"], ["Nov", "115"], ["Dec", "130"],
            [],
            ["Top Categories"],
            ["Category", "Percentage"],
            ["Vegetables", "48%"],
        ...
        <div style={{ padding: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
                {[
                    ...
                    <div key={i} className="card animate-tile">
